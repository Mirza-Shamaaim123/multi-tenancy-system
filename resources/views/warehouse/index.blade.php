                                ...
                                <table class="w-full text-sm text-left border border-gray-200">
                                    ...
                                    <tbody class="divide-y divide-gray-100 divide-x-0">
                                        <tr
                                            ...
                                            <td class="px-6 py-4 font-medium text-gray-900">Alpha Traders</td>
                                            {{-- <td class="px-6 py-4 text-gray-700">alpha@gmail.com</td> --}}
                                            ...
                                            <td class="px-6 py-4 text-gray-600">12 Oct 2025</td>
                                        ...
                                        <tr
                                            ...
                                            <td class="px-6 py-4 font-medium text-gray-900">Beta Warehouse</td>
                                            {{-- <td class="px-6 py-4 text-gray-700">beta@gmail.com</td> --}}
                                            <td class="px-6 py-4 text-gray-700">
                                                <span
                                                    class="inline-block bg-gray-100 px-2 py-1 rounded text-gray-600 text-xs">
                                                    beta.localhost
                                            ...
                                            <td class="px-6 py-4 text-gray-600">15 Oct 2025</td>
                                            <td class="px-6 py-4 text-center">
                                                <div class="flex justify-center items-center space-x-4">
                                                    <a href="#"
                                                        class="px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700 transition">
                                        ...
                                        <tr
                                            ...
                                            <td class="px-6 py-4 font-medium text-gray-900">Gamma Logistics</td>
                                            {{-- <td class="px-6 py-4 text-gray-700">gamma@gmail.com</td> --}}
                                            <td class="px-6 py-4 text-gray-700">
                                                <span
                                                    class="inline-block bg-gray-100 px-2 py-1 rounded text-gray-600 text-xs">
                                                    gamma.localhost
                                            ...
                                            <td class="px-6 py-4 text-gray-600">20 Oct 2025</td>
                                            <td class="px-6 py-4 text-center">
                                                <div class="flex justify-center items-center space-x-4">
                                                    <a href="#"
                                                        class="px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700 transition">

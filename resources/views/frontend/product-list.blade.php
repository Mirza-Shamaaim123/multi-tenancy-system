									...
									<tbody>
											...
											<td>
												<div class="d-flex align-items-center">
													<a href="javascript:void(0);" class="avatar avatar-sm me-2">
														<img src="{{ asset('assets/img/users/user-30.jpg') }}" alt="product">
													</a>
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<a href="javascript:void(0);" class="avatar avatar-sm me-2">
														<img src="{{ asset('assets/img/users/user-13.jpg') }}" alt="product">
													</a>
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<a href="javascript:void(0);" class="avatar avatar-sm me-2">
														<img src="{{ asset('assets/img/users/user-11.jpg') }}" alt="product">
													</a>
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<a href="javascript:void(0);" class="avatar avatar-sm me-2">
														<img src="{{ asset('assets/img/users/user-32.jpg') }}" alt="product">
													</a>
